    ...
    <>
      ...
      {!open && (
        <button
          ...
          className={`fixed right-4 md:right-6 z-20 flex items-center gap-2 rounded-full bg-[#1A3C5E] px-4 py-3.5 text-white shadow-lg transition-all duration-500 hover:opacity-90 hover:scale-105 ${showSticky ? 'bottom-40 min-[1600px]:bottom-24' : 'bottom-24'}`}
        >
