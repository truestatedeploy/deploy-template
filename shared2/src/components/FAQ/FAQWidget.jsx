...
export const FAQWidget = ({ openContactModal }) => {
      ...
      >
        ...
        <div className="px-6 py-5 border-t border-gray-100 bg-white">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 rounded-lg bg-magenta py-3 text-sm font-semibold uppercase tracking-wider text-white shadow-md transition-all duration-300 hover:bg-magentaDark hover:shadow-lg"
          >
