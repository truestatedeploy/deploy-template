            ...
            <ul className="flex flex-col p-4 md:p-0 md:flex-row gap-1 md:gap-8 lg:gap-10 w-full justify-between md:items-center">
              {navLinks.map((link, index) => (
                <li key={index}>
                  <a
                    href={link.href}
                    className="block border-b md:border-0 border-gray-100 py-3 md:py-0 font-semibold text-sm md:text-xs lg:text-sm uppercase tracking-wider text-gray-800 hover:text-magenta transition-colors duration-300"
                  >
                    {link.name}
                  </a>
                </li>
